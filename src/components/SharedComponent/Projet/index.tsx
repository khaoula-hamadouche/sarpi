...
const Projet: React.FC = () => {
    ...
    return (
        <section className="flex flex-wrap justify-center py-24 dark:bg-darklight border-t border-border dark:border-dark_border" id="projet">
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
                <div className="flex items-baseline justify-between flex-wrap">
                    <h2 className="sm:mb-11 mb-3 text-4xl font-bold text-SlateBlueText dark:text-white" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                        Latest projet & news
                    </h2>
